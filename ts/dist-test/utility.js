...
function envOverride(m) {
    if ('TRUE' === process.env.NAVALNYARCHIVE_TEST_LIVE ||
        'TRUE' === process.env.NAVALNYARCHIVE_TEST_OVERRIDE) {
    ...
    m.NAVALNYARCHIVE_TEST_EXPLAIN = process.env.NAVALNYARCHIVE_TEST_EXPLAIN || m.NAVALNYARCHIVE_TEST_EXPLAIN;
    return m;
}
