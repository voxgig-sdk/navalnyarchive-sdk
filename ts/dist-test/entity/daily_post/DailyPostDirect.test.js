...
(0, node_test_1.describe)('DailyPostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NavalnyarchiveSDK({
    ...
    (0, node_test_1.test)('direct-list-daily_post', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-daily_post', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NavalnyarchiveSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['NAVALNYARCHIVE_TEST_DAILY_POST_ENTID'];
    ...
    const client = new __1.NavalnyarchiveSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DailyPostDirect.test.js.map