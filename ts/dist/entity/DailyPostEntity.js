...
class DailyPostEntity extends NavalnyarchiveEntityBase_1.NavalnyarchiveEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'daily_post';
        this.name_ = 'daily_post';
        this.Name = 'DailyPost';
    }
    make() {
        return new DailyPostEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<DailyPost[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.DailyPostEntity = DailyPostEntity;
//# sourceMappingURL=DailyPostEntity.js.map