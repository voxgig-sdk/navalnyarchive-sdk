...
from navalnyarchive_sdk.core.helpers import get_ctx_prop, to_map
...
class NavalnyarchiveContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = NavalnyarchiveControl()
        ...
        if isinstance(sp, NavalnyarchiveSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NavalnyarchiveResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NavalnyarchiveResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return NavalnyarchiveOperation({})
    ...
    def make_error(self, code, msg):
        return NavalnyarchiveError(code, msg, self)
