# Navalnyarchive SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NavalnyarchiveSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NavalnyarchiveSDK(...) and NavalnyarchiveSDK.test(...) become
#      NavalnyarchiveSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "navalnyarchive_sdk"
_SDK_CLASS = "NavalnyarchiveSDK"
