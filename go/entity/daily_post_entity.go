...
import (
	...
	vs "github.com/voxgig-sdk/navalnyarchive-sdk/go/utility/struct"
)

type DailyPostEntity struct {
	name    string
	client  *core.NavalnyarchiveSDK
...
func NewDailyPostEntity(client *core.NavalnyarchiveSDK, entopts map[string]any) *DailyPostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DailyPostEntity) GetName() string { return e.name }
...
func (e *DailyPostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DailyPostEntity) Deleted() bool {
	return e.deleted
}


func (e *DailyPostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDailyPostEntity(e.client, opts)
}

func (e *DailyPostEntity) Data(args ...any) any {
...
func (e *DailyPostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DailyPost; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DailyPostEntity) DataTyped(data ...DailyPost) DailyPost {
	if len(data) > 0 {
		return typedFrom[DailyPost](e.Data(asMap(data[0])))
	}
	return typedFrom[DailyPost](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DailyPost (all fields
// optional at the wire level).
func (e *DailyPostEntity) MatchTyped(match ...DailyPost) DailyPost {
	if len(match) > 0 {
		return typedFrom[DailyPost](e.Match(asMap(match[0])))
	}
	return typedFrom[DailyPost](e.Match())
}
...
func (e *DailyPostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DailyPostEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DailyPostEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DailyPostListMatch and returns []DailyPost. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DailyPostEntity) ListTyped(reqmatch DailyPostListMatch, ctrl map[string]any) ([]DailyPost, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DailyPost](res), nil
}



func (e *DailyPostEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DailyPostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DailyPostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DailyPostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
