...
func registerSDKWords(r *eng.Registry, client *sdk.NavalnyarchiveSDK) {
...
func runOp(client *sdk.NavalnyarchiveSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
