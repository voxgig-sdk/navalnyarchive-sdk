...
// Navalnyarchive SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NavalnyarchiveMakeRequest
{
    public static function call(NavalnyarchiveContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NavalnyarchiveResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NavalnyarchiveResponse($fetched);
        } else {
