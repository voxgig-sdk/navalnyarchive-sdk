...
// Navalnyarchive SDK utility: graphql
//
...
class NavalnyarchiveGraphql
{
    ...
    // equivalent.
    public static function body(NavalnyarchiveContext $ctx): mixed
    {
    ...
    public static function errors(NavalnyarchiveContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
