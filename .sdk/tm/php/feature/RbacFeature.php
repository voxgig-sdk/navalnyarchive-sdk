...
// Navalnyarchive SDK rbac feature
...
class NavalnyarchiveRbacFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _required(NavalnyarchiveContext $ctx): ?string
    {
    ...
    private function _reject(NavalnyarchiveContext $ctx, string $required): void
    {
    ...
    private function _track(NavalnyarchiveContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
