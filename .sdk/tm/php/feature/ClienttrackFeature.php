...
// Navalnyarchive SDK clienttrack feature
...
class NavalnyarchiveClienttrackFeature extends NavalnyarchiveBaseFeature
{
    ...
    public function PostConstruct(NavalnyarchiveContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Navalnyarchive-SDK';
