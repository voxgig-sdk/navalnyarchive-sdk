...
// Navalnyarchive SDK telemetry feature
...
class NavalnyarchiveTelemetryFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _close(NavalnyarchiveContext $ctx, bool $ok): void
    {
