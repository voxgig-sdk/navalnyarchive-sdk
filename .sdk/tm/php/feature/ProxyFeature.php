...
// Navalnyarchive SDK proxy feature
...
class NavalnyarchiveProxyFeature extends NavalnyarchiveBaseFeature
{
    ...
    public function init(NavalnyarchiveContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NavalnyarchiveContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
