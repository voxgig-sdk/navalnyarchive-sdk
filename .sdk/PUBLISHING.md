...
|---|---|---|
| `ts/` | @voxgig-sdk/navalnyarchive-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/navalnyarchive-sdk \
      --repository voxgig-sdk/navalnyarchive-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/navalnyarchive-sdk` shows it, and
`npm trust revoke @voxgig-sdk/navalnyarchive-sdk --id=<id>` removes it.
