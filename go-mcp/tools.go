...
type Args struct {
	Entity string         `json:"entity" jsonschema:"daily_post"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NavalnyarchiveSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "navalnyarchive_list",
		Description: "List records from Navalnyarchive. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "navalnyarchive_load",
		Description: "Load a single record from Navalnyarchive. " +
...
func runOp(client *sdk.NavalnyarchiveSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NavalnyarchiveSDK, name string) (sdk.NavalnyarchiveEntity, error) {
	switch strings.ToLower(name) {
	case "daily_post":
		return client.DailyPost(nil), nil
