// Command Navalnyarchive-mcp is an MCP server exposing the Navalnyarchive
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Navalnyarchive_list  — list records of an entity
//	Navalnyarchive_load  — load a single record of an entity
//
