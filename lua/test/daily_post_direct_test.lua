...
describe("DailyPostDirect", function()
  it("should direct-list-daily_post", function()
    local setup = daily_post_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-daily_post", setup.live and "live" or "unit")
