...
function runner.env_override(m)
  local live = runner.getenv("NAVALNYARCHIVE_TEST_LIVE")
  local override = runner.getenv("NAVALNYARCHIVE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NAVALNYARCHIVE_TEST_EXPLAIN")
