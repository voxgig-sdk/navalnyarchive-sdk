...
module NavalnyarchiveTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("NAVALNYARCHIVE_TEST_LIVE")
    override = getenv("NAVALNYARCHIVE_TEST_OVERRIDE")
    ...
    explain = getenv("NAVALNYARCHIVE_TEST_EXPLAIN")
    m["NAVALNYARCHIVE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NavalnyarchiveTestRunner
Helpers = NavalnyarchiveHelpers
Vs = VoxgigStruct
