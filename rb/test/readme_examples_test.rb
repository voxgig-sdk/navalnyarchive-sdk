...
#      offline in seeded test mode (NavalnyarchiveSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Navalnyarchive_sdk.rb")
  SDK_CLASS = "NavalnyarchiveSDK"
