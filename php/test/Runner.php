...
class NavalnyarchiveTestRunner
{
    ...
    {
        $live = self::getenv('NAVALNYARCHIVE_TEST_LIVE');
        $override = self::getenv('NAVALNYARCHIVE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NAVALNYARCHIVE_TEST_EXPLAIN');
...
class_alias('NavalnyarchiveTestRunner', 'Runner');
class_alias('NavalnyarchiveHelpers', 'Helpers');
