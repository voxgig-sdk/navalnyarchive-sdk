...
// Navalnyarchive SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NavalnyarchiveSDK::test)
...
{
    private const SDK_CLASS = 'NavalnyarchiveSDK';
    ...
    private const SDK_BASE = 'navalnyarchive_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../navalnyarchive_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
