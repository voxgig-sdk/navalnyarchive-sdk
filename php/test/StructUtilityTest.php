...
// Navalnyarchive SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NavalnyarchiveOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NavalnyarchiveOmni::structfix($now, Struct::undef()))
                        !== json_encode(NavalnyarchiveOmni::structfix($val, Struct::undef()))) {
