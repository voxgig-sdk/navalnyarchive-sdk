...
// Navalnyarchive SDK pipeline test
//
...
require_once __DIR__ . '/../navalnyarchive_sdk.php';
...
{
    private static function utility(): NavalnyarchiveUtility
    {
        return new NavalnyarchiveUtility();
    }
    ...
    private static function ctx(array $over = []): NavalnyarchiveContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NavalnyarchiveContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NavalnyarchiveOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NavalnyarchiveError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NavalnyarchiveOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NavalnyarchiveMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NavalnyarchiveOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NavalnyarchiveMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NavalnyarchiveOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NavalnyarchiveMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NavalnyarchiveSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NavalnyarchiveMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NavalnyarchiveResponse([]),
            'result' => new NavalnyarchiveResult([]),
        ]);
        [, $err] = NavalnyarchiveMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NavalnyarchiveSpec([]),
            'response' => null,
            'result' => new NavalnyarchiveResult([]),
        ]);
        [, $err] = NavalnyarchiveMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NavalnyarchiveSpec(['step' => 's']),
            'response' => new NavalnyarchiveResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NavalnyarchiveResult([]),
        ]);
        [, $err] = NavalnyarchiveMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NavalnyarchiveSpec(['step' => 's']),
            'response' => new NavalnyarchiveResponse(self::resp(200, ['v' => 1])),
            'result' => new NavalnyarchiveResult([]),
        ]);
        [, $err] = NavalnyarchiveMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NavalnyarchiveSpec(['step' => 's']),
            'response' => new NavalnyarchiveResponse(self::resp(200, ['v' => 2])),
            'result' => new NavalnyarchiveResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NavalnyarchiveMakeResponse::call($ctx);
    ...
    {
        $preset = new NavalnyarchiveResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NavalnyarchiveSpec([]),
            'response' => new NavalnyarchiveResponse([]),
            'result' => new NavalnyarchiveResult([]),
        ...
        [$got, $err] = NavalnyarchiveMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NavalnyarchiveResult([])]);
        [, $err] = NavalnyarchiveMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NavalnyarchiveSpec([]), 'result' => null]);
        [, $err] = NavalnyarchiveMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NavalnyarchiveSpec(['step' => 's']),
            'result' => new NavalnyarchiveResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NavalnyarchiveOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NavalnyarchiveMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NavalnyarchiveSpec(['step' => 's']),
            'result' => new NavalnyarchiveResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NavalnyarchiveOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NavalnyarchiveMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NavalnyarchiveResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NavalnyarchiveSpec([]),
            'result' => new NavalnyarchiveResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NavalnyarchiveMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NavalnyarchiveMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NavalnyarchiveError('boom', 'boom');
        $utility->fetcher = function (NavalnyarchiveContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NavalnyarchiveSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NavalnyarchiveMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NavalnyarchiveContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NavalnyarchiveMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NavalnyarchiveResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NavalnyarchiveMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NavalnyarchiveContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NavalnyarchiveSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NavalnyarchiveMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NavalnyarchiveResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NavalnyarchiveSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NavalnyarchiveMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NavalnyarchiveMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NavalnyarchiveMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NavalnyarchiveResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NavalnyarchiveDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NavalnyarchiveResult(['ok' => false])]);
        $this->expectException(NavalnyarchiveError::class);
        NavalnyarchiveDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NavalnyarchiveResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NavalnyarchiveMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NavalnyarchiveMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NavalnyarchiveBaseFeature();
        $b = new NavalnyarchiveBaseFeature();
        NavalnyarchiveFeatureAdd::call($ctx, $a);
        NavalnyarchiveFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NavalnyarchiveBaseFeature
    {
        $f = new NavalnyarchiveBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NavalnyarchiveFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NavalnyarchiveContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NavalnyarchiveSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NavalnyarchivePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NavalnyarchivePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NavalnyarchiveResponse(['headers' => null]),
            'result' => new NavalnyarchiveResult([]),
        ]);
        NavalnyarchiveResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NavalnyarchiveResultBody::call($ctx);
