...
// Navalnyarchive SDK utility: fetcher

class NavalnyarchiveFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NavalnyarchiveSDK/1.0)';
    ...
    public static function call(NavalnyarchiveContext $ctx, string $fullurl, array $fetchdef): array
    {
