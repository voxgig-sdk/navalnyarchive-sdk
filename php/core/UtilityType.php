...
// Navalnyarchive SDK utility type

class NavalnyarchiveUtility
{
    ...
    public static function copy(NavalnyarchiveUtility $src): NavalnyarchiveUtility
    {
        $u = new NavalnyarchiveUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
