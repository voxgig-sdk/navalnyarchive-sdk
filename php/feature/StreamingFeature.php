...
// Navalnyarchive SDK streaming feature
...
class NavalnyarchiveStreamingFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _iterate(NavalnyarchiveResult $result): \Generator
    {
    ...
    private function _streamable(NavalnyarchiveContext $ctx): bool
    {
