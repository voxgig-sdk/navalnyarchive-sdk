...
// Navalnyarchive SDK audit feature
...
class NavalnyarchiveAuditFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _emit(NavalnyarchiveContext $ctx, string $outcome): void
    {
