...
// Navalnyarchive SDK idempotency feature
...
class NavalnyarchiveIdempotencyFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _mutating(NavalnyarchiveContext $ctx): bool
    {
