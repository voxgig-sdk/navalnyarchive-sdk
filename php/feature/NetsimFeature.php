...
// Navalnyarchive SDK netsim feature
...
class NavalnyarchiveNetsimFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _simulate(NavalnyarchiveContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NavalnyarchiveContext $ctx, array $applied): void
    {
        $client = $this->client;
