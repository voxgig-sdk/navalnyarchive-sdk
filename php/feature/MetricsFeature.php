...
// Navalnyarchive SDK metrics feature
...
class NavalnyarchiveMetricsFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _record(NavalnyarchiveContext $ctx, bool $ok): void
    {
