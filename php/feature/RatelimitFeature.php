...
// Navalnyarchive SDK ratelimit feature
...
class NavalnyarchiveRatelimitFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _acquire(NavalnyarchiveContext $ctx): void
    {
    ...
    private function _track(NavalnyarchiveContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
