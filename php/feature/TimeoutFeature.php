...
// Navalnyarchive SDK timeout feature
...
class NavalnyarchiveTimeoutFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _with_timeout(NavalnyarchiveContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NavalnyarchiveContext $_ctx, float $ms): void
    {
        $client = $this->client;
