...
// Navalnyarchive SDK cache feature
...
class NavalnyarchiveCacheFeature extends NavalnyarchiveBaseFeature
{
    ...
    private function _through(NavalnyarchiveContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
